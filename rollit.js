...
rollup.rollup({
    ...
    b.then(what=>{
        ...
        try{
            var result = UglifyJS.minify('dist/dom-point-state.js');
            //console.log('result ',result)
            writeFile('dist/dom-point-state.min.js', result.code, onErrorCB('minify'));
        }catch(e){
